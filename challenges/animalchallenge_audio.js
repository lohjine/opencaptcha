...
challengeDiv.style.marginTop = "2%"

var content_pre = document.createElement('span');
content_pre.textContent = 'Name the 5 animals in order.'
...
function submit_challenge(){
	...
	// clean answer by replacing commas with space, normalizing spaces, trimming
	var answer = challengeDiv.children[2].value
	answer = answer.replace(',',' ').replace(/\s\s+/g, ' ').trim()
